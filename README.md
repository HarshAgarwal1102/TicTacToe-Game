...
![TICTAC](https://github.com/king4404/TicTacToe-Game/assets/117922914/70bca25f-a785-42db-841d-19820138c95e)
 ...
 # ***Java Swing GUI project for a Tic Tac Toe game with a detailed description of the project :<br><br>***
...
- If there is a winner or a match draw, the game logic will update the player’s score and display it in the respective JTextFields.<br><br>
...
- **Exiting the application:** Clicking the “Exit” button or closing the game window will terminate the application.<br><br>
